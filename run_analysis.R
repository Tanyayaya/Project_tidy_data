setwd("E:/R/cousera")
library(data.table)
train_set<-fread("E:/R/cousera/UCI HAR Dataset/train/X_train.txt")
train_label<-fread("E:/R/cousera/UCI HAR Dataset/train/y_train.txt",
                   col.names = "label")
train_subject<-fread("E:/R/cousera/UCI HAR Dataset/train/subject_train.txt",
                     col.names = "subject")
train_data<-cbind(train_subject,train_label,train_set)
test_set<-fread("E:/R/cousera/UCI HAR Dataset/test/X_test.txt")
test_label<-fread("E:/R/cousera/UCI HAR Dataset/test/y_test.txt",
                  col.names = "label")
test_subject<-fread("E:/R/cousera/UCI HAR Dataset/test/subject_test.txt",
                    col.names="subject")
test_data<-cbind(test_subject,test_label,test_set)
data<-rbind(test_data,train_data)
feature<-read.table("E:/R/cousera/UCI HAR Dataset/features.txt")
